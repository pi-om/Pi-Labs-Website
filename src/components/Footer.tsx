      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://www.linkedin.com/company/pi-labs-ai/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="mailto:info@pi-labs.com" className="text-gray-300 hover:text-white transition-colors">
                  info@pi-labs.com
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 Pi-Labs. All rights reserved.
          </p>
